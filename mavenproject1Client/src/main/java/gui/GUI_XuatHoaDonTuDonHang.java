...
public class GUI_XuatHoaDonTuDonHang extends JDialog {
    ...
    public GUI_XuatHoaDonTuDonHang() throws java.rmi.RemoteException {
        try {
        ...
        initComponents();
        // other method calls that might throw RemoteException
    ...
    public GUI_XuatHoaDonTuDonHang(ArrayList<Vector> dsGioHang, double tongTien, Object nhanVien, Object khachHang, String hoaDon) throws java.rmi.RemoteException {
        this();
...
//        kh.setVisible(true);
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            ...
            for (Vector vec : dsGioHang) {
                ...
                int sl = 0;
                double dg = 0.0;
                sl = Integer.parseInt(vec.get(2) + "");
                String value = vec.get(3) + "";
                value = value.replace(",", "").replace(".", "");
                dg = Double.parseDouble(value);
    ...
    private void xuLyHienThiHoaDon() throws RemoteException {
...
//            System.out.println(giaGiamKM);
    ...
    public void luuHoaDon(String maHD, LocalDate ngayTao, String maKh, String maNV) throws RemoteException {
...
//        dao.themHD(cthd);
//    }
    public void luuCTHoaDon(String maHD, String maSP, int soLuong, double donGia) throws RemoteException {
        ChiTietHoaDon cthd = new ChiTietHoaDon();
